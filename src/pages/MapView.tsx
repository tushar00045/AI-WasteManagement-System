        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div className="relative h-[600px] overflow-hidden">
                  ...
                  <div className="bg-gray-200 h-full flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <p className="text-gray-500 max-w-md">
                        Add your Google Maps API key to the .env file as
                ...
                {/* Legend */}
                <div className="absolute top-4 right-4 bg-white rounded-lg shadow-lg p-4 flex items-center space-x-4 z-10">
                ...
                {/* Map controls */}
                <div className="absolute bottom-4 left-4 bg-white rounded-lg shadow-lg p-3 flex space-x-2 z-10">
